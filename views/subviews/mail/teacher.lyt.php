...
<html>
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <h5>Welcome to Diamondville</h5>
        <p>
          You are warmly welcome to Diamondville Comprehensive School web application. <br><br>
          We acknowledge your registration on the platform with this email <b><* echo $body->email *></b>, we recommend you update your profile.
          <br><br>
          From Management.
        </p>
      </div>

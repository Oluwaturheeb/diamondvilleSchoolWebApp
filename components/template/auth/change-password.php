...
if (req()) {
    $a = new Auth('ad_user');
    $log = $a->chpwd(['password_hash', 'vpassword_hash']);
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-3 mx-auto">
                    ...
                    <form class="form-group" method="post" id="Tlogin">
                        ...
                        <div class="form-group">
                            <label for="vpasssword">Verify Password</label>
                            <input type="password" name="vpassword_hash" placeholder="Create a password" class="form-control" id="vpassword">
                        </div>
                        <div class="form-group">
                            <div class="info"></div>

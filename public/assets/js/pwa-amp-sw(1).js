...
const OFFLINE_PAGE = 'https://www.delonifera.ng/?amp=1';
const NOT_FOUND_PAGE = 'https://www.delonifera.ng/?amp=1';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://www.delonifera.ng//wp-admin/');
//    },
];
